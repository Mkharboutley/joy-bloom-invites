...
exports.onSMSStatusUpdate = exports.sendPushNotification = exports.sendBulkSMS = exports.sendSMS = void 0;
...
exports.sendSMS = functions.https.onCall(async (data, context) => {
    try {
        ...
        const docRef = await admin.firestore().collection('sms').add(Object.assign(Object.assign({}, smsData), { status: 'pending', createdAt: admin.firestore.FieldValue.serverTimestamp(), templateId: templateId || null }));
...
exports.sendBulkSMS = functions.https.onCall(async (data, context) => {
    try {
        ...
        throw new functions.https.HttpsError('internal', 'Failed to send bulk SMS', error);
    }
});
